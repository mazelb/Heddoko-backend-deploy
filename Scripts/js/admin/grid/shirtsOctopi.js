...
var ShirtsOctopi = {
    ...
    datasources: function() {
        ...
        this.shirtOctopiQAStatusTypes = new kendo.data.DataSource({
            data: _.values(Enums.ShirtOctopiQAStatusType.array)
        });

        this.shirtOctopiQAStatusTypes.read();
    },
    ...
    init: function() {
        ...
        if (control.length > 0) {
            this.controls.grid = control.kendoGrid({
                ...
                detailTemplate: kendo.template($("#shirtoctopi-qastatuses-template").html()),
            ...
            this.controls.addModel = kendo.observable({
                ...
                qaStatuses: Datasources.shirtOctopiQAStatusTypes,
