...
var PantsOctopi = {
    ...
    datasources: function() {
        ...
        this.pantsOctopiQAStatusTypes = new kendo.data.DataSource({
            data: _.values(Enums.PantsOctopiQAStatusType.array)
        });
    ...
    init: function() {
        ...
        if (control.length > 0) {
            this.controls.grid = control.kendoGrid({
                ...
                detailTemplate: kendo.template($("#pantsoctopi-qastatuses-template").html()),
            ...
            this.controls.addModel = kendo.observable({
                ...
                qaStatuses: Datasources.pantsOctopiQAStatusTypes,
