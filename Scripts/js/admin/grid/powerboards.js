...
var Powerboards = {
    ...
    datasources: function() {
        ...
        this.powerboardQAStatusTypes = new kendo.data.DataSource({
            data: _.values(Enums.PowerboardQAStatusType.array)
        });

        this.powerboardQAStatusTypes.read();
    },
    ...
    init: function() {
        ...
        if (control.length > 0) {
            this.controls.grid = control.kendoGrid({
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            template: function (e) {
                                return Format.powerboard.qaStatus(e.qaStatusText);
                            },
                            editor: KendoDS.emptyEditor
                        },
                        {
                    ...
                    detailTemplate: kendo.template($("#powerboards-qastatuses-template").html()),
            ...
            this.controls.addModel = kendo.observable({
                ...
                qaStatuses: Datasources.powerboardQAStatusTypes,
    ...
    onSaveQAStatus: function (e) {
        ...
        Powerboards.controls.grid.dataSource.sync();
    },
